    ...
    <div class="max-w-6xl mx-auto px-6 lg:px-10 relative">
      ...
      <div class="grid grid-cols-3 gap-4 md:gap-8 items-end px-12 md:px-16">
        <div class="opacity-70 scale-90 transition-all duration-500">
          <img :src="currentSlide.left" alt="App IGP - vista mapa" width="280" height="560" loading="lazy"
            decoding="async" class="w-full" />
        </div>
        <div class="relative z-10 transition-all duration-500">
          ...
          <img :src="currentSlide.center" alt="App IGP - pantalla principal" width="320" height="640" loading="lazy"
            decoding="async" class="w-full drop-shadow-2xl" />
        </div>
        <div class="opacity-70 scale-90 transition-all duration-500">
          <img :src="currentSlide.right" alt="App IGP - red de volcanes" width="280" height="560" loading="lazy"
            decoding="async" class="w-full" />
        </div>
      </div>
